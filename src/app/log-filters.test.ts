...
describe('log filters', () => {
  const sample = [
    '2026-06-09 21:07:11.717959 (teleno_node.jeimN) [p2p_node.cpp:673] <info>: [p2p] Syncing from QmSeed',
    '2026-06-09 21:07:19.552868 (teleno_node.jeimN) [controller.cpp:467] <info>: Sync progress - Height: 47000',
    '2026-06-09 21:08:00.000000 (teleno_node.jeimN) [db.cpp:42] <error>: [db] Failed to open RocksDB',
  ...
  it('parses message component tags before falling back to process component names', () => {
    ...
    expect(parseLogLineComponent('(teleno_node.jeimN) [main.cpp:1] <info>: hello')).toBeNull()
  })
