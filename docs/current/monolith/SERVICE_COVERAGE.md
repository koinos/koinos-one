...
The missing work is tracked in `../../backlog/README.md`. The highest-risk
legacy-service gap is full account history parity, followed by historical
backfill/import for transaction and contract metadata indexes.
