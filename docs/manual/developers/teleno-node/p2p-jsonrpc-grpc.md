...
Use `scripts/compare-jsonrpc-parity.py`, `scripts/compare-grpc-parity.sh`, and
`scripts/validate-grpc-client-compatibility.sh` when a change touches public API
behavior.
