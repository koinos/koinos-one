...
`NodeConfig` in
[`core/config.hpp`](https://github.com/koinos/teleno/blob/main/src/core/config.hpp)
...
[`core/service_registry.hpp`](https://github.com/koinos/teleno/blob/main/src/core/service_registry.hpp)
