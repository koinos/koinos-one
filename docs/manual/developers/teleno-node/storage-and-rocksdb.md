...
[`docs/backlog/storage/UNIFIED_ROCKSDB_IMPLEMENTATION_PLAN.md`](https://github.com/koinos/koinos-one/blob/main/docs/backlog/storage/UNIFIED_ROCKSDB_IMPLEMENTATION_PLAN.md).
