...
| --- | --- | --- |
| Renderer | [`src/main.tsx`](https://github.com/koinos/koinos-one/blob/main/src/main.tsx), [`src/App.tsx`](https://github.com/koinos/koinos-one/blob/main/src/App.tsx), [`src/components/`](https://github.com/koinos/koinos-one/tree/main/src/components) | React UI, local UI state, polling, display formatting, and user interactions. |
| Preload | [`electron/preload.ts`](https://github.com/koinos/koinos-one/blob/main/electron/preload.ts) | Exposes a controlled `window.teleno` API to the renderer. |
| Main process | [`electron/main.ts`](https://github.com/koinos/koinos-one/blob/main/electron/main.ts), [`electron/lib/`](https://github.com/koinos/koinos-one/tree/main/electron/lib) | Filesystem access, subprocesses, native node control, wallet actions, backup calls, and IPC handlers. |
