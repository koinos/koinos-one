...
Use these repository paths when the manual summary is not enough:
...
`docs/current/`, `docs/roadmap/`, `docs/backlog/`, and `docs/archive/` areas.
...
- Update GUI copy and `src/i18n.ts` together for every user-facing GUI change.
